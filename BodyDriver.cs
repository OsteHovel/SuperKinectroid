...
{
    public class BodyDriver : IDisposable
    {
        /// <summary>
        ...
        public BodyDriver(KinectSensor kinectSensor, DrawingImage imageSource)
        {
...
//            var frameDescription = kinectSensor.DepthFrameSource.FrameDescription;
            ...
            bodyColors = new List<Pen>
            {
                ...
                new Pen(Brushes.Orange, thickness),
                new Pen(Brushes.Green, thickness),
                new Pen(Brushes.Blue, thickness),
                new Pen(Brushes.Indigo, thickness),
                new Pen(Brushes.Violet, thickness)
            };
...
//            drawingGroup = new DrawingGroup();
            drawingGroup = imageSource.Drawing as DrawingGroup;
...
//            imageSource = new DrawingImage(drawingGroup);
        ...
        private void Reader_FrameArrived(object sender, BodyFrameArrivedEventArgs e)
        {
            ...
            if (dataReceived)
            {
                MainWindow.UpdateBodies(bodies);
                
                using (DrawingContext dc = drawingGroup.Open())
                {
                    // Draw a transparent background to set the render size
                    dc.DrawRectangle(Brushes.Transparent, null,
                        new Rect(0.0, 0.0, displayWidth, displayHeight));
...
//                        Pen drawPen = bodyColors[0];
                        ...
                        if (body.IsTracked)
                        {
                            ...
                            foreach (JointType jointType in joints.Keys)
                            {
                                ...
                                var depthSpacePoint = coordinateMapper.MapCameraPointToColorSpace(position);
                    ...
                    drawingGroup.ClipGeometry =
                        new RectangleGeometry(new Rect(0.0, 0.0, displayWidth, displayHeight));
                }
            }
        }
        ...
        public static DrawingImage GetSource()
        {
